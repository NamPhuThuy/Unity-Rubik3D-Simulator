...
public class ReadCube : MonoBehaviour
{
    ...
    public Transform tFront, tBack;

    private List<GameObject> frontRays = new List<GameObject>(), backRays = new List<GameObject>();
    private List<GameObject> upRays = new List<GameObject>(), downRays = new List<GameObject>();
    private List<GameObject> leftRays = new List<GameObject>(), rightRays = new List<GameObject>();
