...
{
    // sides
    public List<GameObject> front = new List<GameObject>(), back = new List<GameObject>();
    public List<GameObject> up = new List<GameObject>(), down = new List<GameObject>();
    public List<GameObject> left = new List<GameObject>(), right = new List<GameObject>();
